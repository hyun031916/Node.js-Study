...
const sql = {
    ...
    insert: "insert into login(id, password, phone_number, email, reg_date) values(?, ?, ?, ?)",
    read: "select * from emp where id=?",
    update: "update emp set id=?, phone_number=?, email=? where id=?",
...
app.post('/new', (req, res)=>{
    ...
    console.log(_id, _password, _phone_number, _email, _joinDate);
    conn.query(sql.insert, [_id, _password,_phone_number, _email, _joinDate], (err)=>{
